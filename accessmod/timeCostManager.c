...
{ 
  ...
  printf("Power in watt %f for a flat speed of %f\n ", P,veloc*3.6);
  /*slope in radian*/  
  float beta=atan(slope); 
  printf("beta value=\%f ",beta);
  /**/
...
int main()
{
/* current,adj1,adj2,adj3,slope,dist,tot_reviwed*/
  double res=costManager(3020,3020,0,0,-0.05,90,8);
